...
import { getDashboardStats, getLoans, updateLoanStatus, recordRepayment, verifyDocument, getUsers, getUserDocuments, verifyUserKyc, getPendingRepayments, verifyRepayment } from "../controllers/admin.controller.js";
